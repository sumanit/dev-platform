...
@ApiModel(value="TableInfoDTO-")
public class TableInfoDTOBase extends TableInfo implements DTOInterface<TableInfo> {
    ...
    @JsonIgnore
    @ApiParam(value = "(schema) 在该数组中")
    private List<String> schema_arr;

    @JsonIgnore
    @ApiParam(value = "(schema) like 该值(需自己在前后加%)")
    private String schema_like;

    @JsonIgnore
    @ApiParam(value = "(catalog) 在该数组中")
    private List<String> catalog_arr;

    @JsonIgnore
    @ApiParam(value = "(catalog) like 该值(需自己在前后加%)")
    private String catalog_like;
    ...
    public TableInfoDTOBase() {
        this(null);
    }

    public TableInfoDTOBase(TableInfo tableInfo) {
        if(tableInfo == null) {
    ...
    public void setModel(TableInfo tableInfo) {
        this.tableInfo = tableInfo;
    }
    ...
    public String getCatalog() {
        ...
        return this.getModel().getCatalog();
    }
    ...
    public List<String> getSchema_arr() {
        return schema_arr;
    }

    public void setSchema_arr(List<String> schema_arr) {
        this.schema_arr = schema_arr;
    }

    public String getSchema_like() {
        return schema_like;
    }

    public void setSchema_like(String schema_like) {
        this.schema_like = schema_like;
    }

    public List<String> getCatalog_arr() {
        return catalog_arr;
    }

    public void setCatalog_arr(List<String> catalog_arr) {
        this.catalog_arr = catalog_arr;
    }

    public String getCatalog_like() {
        return catalog_like;
    }

    public void setCatalog_like(String catalog_like) {
        this.catalog_like = catalog_like;
    }
